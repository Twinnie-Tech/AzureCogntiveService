...
const ColorsForm = () => {
  ...
  const getTags = async(url:string)=>{
   return await axios.post("http://localhost:8000/api/v1/customVision/colorScheme",{
    image:  url,
    headers: {
...
const handleResetClick = () => {
  ...
  return (
    ...
    <div className="container mx-auto max-w-screen-lg h-full">
      <h4 className="text-center font-bold text-lg my-3">Check Colors</h4>

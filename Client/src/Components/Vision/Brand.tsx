...
const Brand = () => {
  ...
  const getTags = async(url:string)=>{
   return await axios.post("http://localhost:8000/api/v1/customVision/brands",{
    image:  url,
    headers: {
 ...
 if(imageBrand){
  ...
  data.append("folder", "ImageBrands");
  try{
...
const handleResetClick = () => {
  ...
  return (
    ...
    <div className="container mx-auto max-w-screen-lg h-full">
      <h4 className="text-center font-bold text-lg my-3">Check Image Brands</h4>
